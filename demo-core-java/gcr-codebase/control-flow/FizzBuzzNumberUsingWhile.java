// a program FizzBuzz using while loop, take a number as user input, and 
...
import java.util.*;
public class FizzBuzzNumberUsingWhile {
    ...
    public static void main(String[] args) {
        ...
        if (number<=0) {
            ...
            // here we run the loop from 1 to user input number using while loop
            int i = 1;
            while (i<=number) {
